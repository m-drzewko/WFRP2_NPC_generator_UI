...
import { RacesResponseObject } from "./races-response-object";
...
export class RaceService {
    ...
    getRaces(): Observable<RacesResponseObject> {
        let headers = new HttpHeaders()
            .set('Accept-Language', this.translate.currentLang);

        return this.httpClient.get<RacesResponseObject>(this.getAllRacesUrl, {
            headers: headers
        })
        .pipe(
